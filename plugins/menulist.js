 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya Ditya BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 DITYA - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 DITYA - BOT..."},
	]
    },{
	...
	return conn.sendButton(m.chat, text, wm, img2, [["🥞MENU", _p + "menu"], ["🌸SCRIPT", _p + "sc"]], m, {
        contextInfo: {
            externalAdReply: {
                ...
                body: 'Source Code By DityaAstawa',
                previewType: 0,
                thumbnail: img
            }
        }
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By Ditya TEAM',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://dityaastawa.github.io/'
                    }
                },
                {
                    urlButton: {
